...
class HashPbkdf2Test extends PHPUnit_Framework_TestCase
{
    ...
    {
        return array(
            'RFC test vector #1' => array('password',                 'salt',                                 'sha1', 1,    40, '0c60c80f961f0e71f3a9b524af6012062fe037a6'),
            'RFC test vector #2' => array('password',                 'salt',                                 'sha1', 2,    40, 'ea6c014dc72d6f8ccd1ed92ace1d41f0d8de8957'),
            'RFC test vector #3' => array('password',                 'salt',                                 'sha1', 4096, 40, '4b007901b765489abead49d926f721d065a429c1'),
            // for test vector 4, see testHashPbkdf2WithManyIterations() below
            'RFC test vector #5' => array('passwordPASSWORDpassword', 'saltSALTsaltSALTsaltSALTsaltSALTsalt', 'sha1', 4096, 50, '3d2eec4fe41c849b80c8d83662c0e44a8b291a964cf2f07038'),
            'RFC test vector #6' => array("pass\0word",               "sa\0lt",                               'sha1', 4096, 32, '56fa6aa75548099dcc37d7f03425e0c3'),
    ...
    {
        $hexHash = hash_pbkdf2($algo, $password, $salt, $iterations, $length);
    ...
    {
        $this->testHashPbkdf2('password', 'salt', 16777216, 40, 'eefe3d61cd4da4e4e9945b3d6ba2158c2634e984');
    }
}
